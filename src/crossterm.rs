    ...
    loop {
        terminal.draw(|rect| {
            ...
            match active_menu_item {
                ...
                MenuItem::Stats => render_session(rect, app, chunks[1]), 
            }
        ...
        match rx.recv()? {
            Event::Input(event) => match event.code {
                ...
                KeyCode::Char('p') => active_menu_item = MenuItem::Session,
                KeyCode::Char('s') => active_menu_item = MenuItem::Session,
                KeyCode::Char('l') => active_menu_item = MenuItem::Session,
                KeyCode::Left => active_menu_item = MenuItem::Session,
                KeyCode::Right => active_menu_item = MenuItem::Session,
                _ => {}
            },
            Event::Tick => {}
        }
